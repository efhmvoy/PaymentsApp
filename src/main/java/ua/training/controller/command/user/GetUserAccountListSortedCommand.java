...
public class GetUserAccountListSortedCommand implements Command {
    ...
    public GetUserAccountListSortedCommand(AccountService accountService) {
    ...
    public String execute(HttpServletRequest request) throws ServletException, IOException {
        ...
        try{
            accountList = accountService.getAccountListByUserSorted(userLogin, sortValue);
